...
public class ExampleCreatedExtension implements PreZipExtension {
    ...
    public final String DESCRIPTION = "Small and basic example for a PreZip extension. This would run after a server pack was generated, but BEFORE the ZIP-archive would be generated.";
